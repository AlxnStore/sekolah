                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                                                <label for="agama" class="col-sm-3 col-form-label pe-0">Agama</label>
                                                                <div class="col-sm-9">
                                                                    <input type="text" readonly class="form-control border-0 bg-transparent" id="agama" value=": <?= $profile['agama']?>"readonly>
                                                                </div>
                                                            </div>
                                        <div class="row">
