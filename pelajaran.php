...
if ($msg == 'updated') {
    ...
    <i class="fa-solid fa-circle-check"></i> Pelajaran berhasil di perbarui....
</div>';
}
                                        ...
                                        <form action="proses-pelajaran.php" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="jurusan" id="jurusan" class="form-select" required>
                                                    ...
                                                    <option value="TEKNIK KOMPUTER JARINGAN">TEKNIK KOMPUTER JAIRNGA</option>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $data['guru'] ?></td>
                                                    <td align="center">
                                                        <a href="edit-pelajaran.php?id=<?= $data['id'] ?>" class="btn btn-sm btn-warning" title="updatepelajaran"><i class="fa-solid fa-pen"></i></a>
                                            ...
                                            <tr>
                                                <td colspan="5" align="center">Tidak ada data yang sesuai..!!</td>
                                            </tr>    
                                                <?php } ?>
                                            </tbody>
                                        </table>
