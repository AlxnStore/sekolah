                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <span class="h-5 my-2"><i class="fa-solid fa-pen-to-square"></i> Update Siswa</span>
                            ...
                            <div class="card-body">
                                <div class="row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9" style="margin-left: -50px;">
                                                <select name="jurusan" id="jurusan" class="form-select border-0 border-bottom" required>
                                                    <?php
                                                    $jurusan = ["--Pilih Jurusan--", "KIMIA", "TEKNIK KOMPUTER JARINGAN", "ADMINISTRASI", "AKUTANSI", "ELEKTRONIKA INDUSTRI"];
                                    ...
                                    <div class="col-4 text-center px-5">
                                        ...
                                        <small class="text-secondary">Pilih Foto</small>
                                    </div>
                                </div>
                            </div>
                        </div>
